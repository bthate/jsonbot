...
from jsonbot.object import Object, Wd, items, keys, register, update, values
from jsonbot.object import edit, kind, load, save
from jsonbot.object import ObjectDecoder, ObjectEncoder
from jsonbot.object import printable
...
class TestObject(unittest.TestCase):
    ...
    def test_kind(self):
        self.assertEqual(kind(Object()), "jsonbot.object.Object")
